...
def test_all_diagrams():
    ...
    for i, mmd_file in enumerate(sorted(mmd_files), 1):
        ...
        # Test rendering
        renders_successfully, message = test_diagram_rendering(diagram_content, mmd_file.name)
    ...
    print("=" * 80)
    print(f"📊 Rendering Test Results:")
    ...
    print(f"   Success rate: {(results['renders_successfully']/results['total']*100):.1f}%")
    ...
    if results['error_details']:
        ...
        print(f"   3. Fix incomplete arrow syntax (-- vs -->)")
        print(f"   4. Escape special characters in node labels")
        print(f"   5. Ensure proper node definitions")
...
"""
    ...
    print(f"📋 Detailed report generated: mermaid_rendering_issues_report.md")
...
if __name__ == "__main__":
    ...
    if results['rendering_errors'] > 0:
        ...
        print(f"📋 Check 'mermaid_rendering_issues_report.md' for detailed analysis")
    else:
